...
#define FILENAME_BIN_SALARIO "TABELA_SALARIO.dat"
#define FILENAME_LOG "LOG.txt"
#define FILENAME_CSV_SALARIO "processamento_salario.csv"
#define FILENAME_SALARIO_CONTAS "SALARIO.txt"
//ENUMERAÇOES
...
#define MAX_CARACTERES_CSV 10

#define TAMANHO_INICIAL 10

#define MIN_OP_MENU_FUNCIONARIO 0
#define MAX_OP_MENU_FUNCIONARIO 6
#define MIN_OP_MENU_SALARIO 0
#define MAX_OP_MENU_SALARIO 9
#define MIN_OP_MENU_PRINCIPAL 0
#define MAX_OP_MENU_PRINCIPAL 2
...
#define ERRO_LISTA_FUNCIONARIO_VAZIA "A lista de funcionarios está vazia"
#define ERRO_LISTA_SALARIO_VAZIA "A tabela dos salarios está vazia"
...
#define OBTER_DIA_SALARIO "Insira dia -> Salario: "
...
#define OBTER_MES_SALARIO "Insira mes -> Salario: "
...
#define OBTER_ANO_SALARIO "Insira ano -> Salario: "
...
//OPCAO DATA -> SWITCH CASE DA FUNCAO ATUALIZAR DATA DE NASCIMENTO/ENTRADA
#define MIN_OPCAO_DATA 0
#define MAX_OPCAO_DATA 3
#define OBTER_OPCAO_DATA "\n1-DIA\n2-MES\n3-ANO\n0-SAIR\nOpção: "
...
typedef struct{
    char cod_func[50];
    char num_dias_completos[50];
    char num_meio_dias[50];
    char num_dias_fim_de_semana[50];
    char num_de_faltas[50];
...
typedef struct {
    float valor_ss_funcionario;
    float valor_ss_empresa;
    float valor_ss_total;
} TIPO_SS;
